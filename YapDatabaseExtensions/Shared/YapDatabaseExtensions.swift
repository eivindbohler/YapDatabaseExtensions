...
public struct YapDB {
    ...
    */
    public static func pathToDatabase(_ directory: FileManager.SearchPathDirectory, name: String, suffix: String? = nil) -> String {
    ...
    */
    public static func databaseNamed(_ name: String, operations: DatabaseOperationsBlock? = nil) -> YapDatabase {
        let db =  YapDatabase(path: pathToDatabase(.documentDirectory, name: name, suffix: nil))
        operations?(db)
        return db
    }
    ...
    - returns: the YapDatabase instance.
    */
    public static func testDatabase(_ file: String = #file, test: String = #function, operations: DatabaseOperationsBlock? = nil) -> YapDatabase {
...
extension YapDatabaseReadWriteTransaction: WriteTransactionType {
    ...
    public func writeAtIndex(_ index: YapDB.Index, object: AnyObject, metadata: AnyObject? = nil) {
...
public final class YapDBIndexCoder: NSObject, NSCoding, CodingType {
    ...
    public required init(coder: NSCoder) {
        let collection = coder.decodeObject(forKey: "collection") as! String
        let key = coder.decodeObject(forKey: "key") as! String
        value = YapDB.Index(collection: collection, key: key)
    }

    public func encode(with coder: NSCoder) {
        coder.encode(value.collection, forKey: "collection")
        coder.encode(value.key, forKey: "key")
    }
}
