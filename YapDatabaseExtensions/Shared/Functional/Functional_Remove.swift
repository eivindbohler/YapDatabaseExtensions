...
extension ConnectionType {
    ...
    */
    ...
    - parameter item: a `Persistable` item
    */
    public func asyncRemove<Item: Persistable>(_ item: Item, queue: DispatchQueue = DispatchQueue.main, completion: (() -> Void)? = nil) {
    ...
    */
    public func asyncRemove<
        Items, Item>(_ items: Items, queue: DispatchQueue = DispatchQueue.main, completion: (() -> Void)? = nil) where
        Items: Sequence,
        Items.Iterator.Element == Item,
        Item: Persistable {
