    ...
    */
    public enum Fetch: YapDatabaseExtensionRegistrar {
        ...
        */
        ...
        - parameter database: a YapDatabase instance
        - parameter connection: an optional YapDatabaseConnection, defaults to nil
        */
        public func registerInDatabase(_ database: YapDatabase, withConnection connection: YapDatabaseConnection? = nil) {
        ...
        - parameter connection: an optional YapDatabaseConnection, defaults to nil
        */
        public func createViewMappings(_ mappings: Mappings, inDatabase database: YapDatabase, withConnection connection: YapDatabaseConnection? = nil) -> YapDatabaseViewMappings {
            registerInDatabase(database, withConnection: connection)
            return mappings.createMappings(withViewName: name)
        }
    }
}
...
extension YapDB {
    ...
    open class BaseExtension {
        ...
        init(name n: String, version v: String = "1.0", persistent p: Bool = true, collections c: [String]? = nil) {
            name = n
            version = v
            persistent = p
        ...
        */
        open func isRegisteredInDatabase(_ database: YapDatabase) -> Bool {
            return (database.registeredExtension(name) as? YapDatabaseView) != nil
        }
    }
...
extension YapDB {
    ...
    */
    open class View: BaseView, YapDatabaseViewProducer, YapDatabaseExtensionRegistrar {
        ...
        */
        public init(name: String, grouping g: Grouping, sorting s: Sorting, version: String = "1.0", persistent: Bool = true, collections: [String]? = nil) {
            grouping = g
            sorting = s
        ...
        func registerInDatabase(_ database: YapDatabase, withConnection connection: YapDatabaseConnection? = nil) {
    ...
    */
    open class Filter: BaseView, YapDatabaseViewProducer, YapDatabaseExtensionRegistrar {
        ...
        */
        ...
        - parameter collections: an optional array of collections which is used to white list the collections searched when populating the view.
        */
        public init(name: String, parent p: YapDB.Fetch, filtering f: Filtering, version: String = "1.0", persistent: Bool = true, collections: [String]? = nil) {
            parent = p
            filtering = f
            super.init(name: name, version: version, persistent: persistent, collections: collections)
        }
    ...
    */
    open class SearchResults: BaseView, YapDatabaseViewProducer, YapDatabaseExtensionRegistrar {
        ...
        */
        ...
        - parameter collections: an optional array of collections which is used to white list the collections searched when populating the view.
        */
        public init(name: String, parent p: YapDB.Fetch, search: String, columnNames cn: [String], handler h: Handler, version: String = "1.0", persistent: Bool = true, collections: [String]? = nil) {
            parent = p
            searchName = search
            columnNames = cn
            handler = h
        ...
        func createDatabaseView() -> YapDatabaseView {
            return YapDatabaseSearchResultsView(fullTextSearchName: searchName, parentViewName: parent.name, versionTag: version, options: nil)
        }

        func registerInDatabase(_ database: YapDatabase, withConnection connection: YapDatabaseConnection? = nil) {

            if (database.registeredExtension(searchName) as? YapDatabaseFullTextSearch) == nil {
...
extension YapDB {
    ...
    public struct Mappings {
        ...
        func createMappings(withViewName viewName: String) -> YapDatabaseViewMappings {
            switch kind {
...
extension YapDB {
    ...
    public struct FetchConfiguration {
        ...
        public init(fetch f: Fetch, mappings m: Mappings = Mappings(), block b: MappingsConfigurationBlock? = nil) {
            fetch = f
            mappings = m
            block = b
        }
        ...
        public func createMappingsRegisteredInDatabase(_ database: YapDatabase, withConnection connection: YapDatabaseConnection? = nil) -> YapDatabaseViewMappings {
